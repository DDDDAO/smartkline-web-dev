...
export function SymbolIcon({
  ...
  const style = iconUrl ? createAssetIconStyle(iconUrl) : createAvatarFallbackStyle(symbolName);
...
export function getSymbolBaseAsset(symbol: string): string {
  return symbol.replace("/USDT:USDT", "").replace("USDT", "").trim().toUpperCase();
}

function createAssetIconStyle(iconUrl: string): CSSProperties {
  return {
