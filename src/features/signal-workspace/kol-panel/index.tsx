...
import { KolStatsSummaryPanel } from "./stats";
import { FilterEmptyState, KolPanelLoadingState, KolPanelSourceState, WatchedKolSources } from "./states";
import { KolSignalCard } from "./signal-card";
      ...
      <div
        className={
          isDarkTheme
            ...
            : "flex min-h-[48px] items-center justify-between gap-3 border-b border-[#E8E8EC] bg-white px-4 py-2 sm:px-5 lg:py-1.5"
        }
      >
      ...
      <div
        ...
        className={
          isDarkTheme
            ...
            : "kol-scroll-area mr-2 min-h-0 flex-1 space-y-3 overflow-y-auto bg-[#FAFAFA] pb-3 pl-3 pr-1 pt-2"
        }
      >
