...
export const EXCHANGES = [
  ...
  { id: "binanceDemo", apiManagementUrl: BINANCE_DEMO_API_MANAGEMENT_URL, connectorExchangePlatform: "BinanceDemo", defaultAccountName: "Binance Demo #1", enabled: true, fallback: "BN", logoPath: "/exchanges/binance/brand/icon.png", mode: "demo", registrationUrl: null, requiresApiPassword: false, requiresPrivateKey: false, requiresWalletAddress: false },
] as const;
