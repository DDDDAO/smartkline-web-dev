...
import { createTradingFoxConnector } from "@/app/_lib/tradingfox-control-plane";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(await createTradingFoxConnector(session, await request.json()));
  } catch (error) {
