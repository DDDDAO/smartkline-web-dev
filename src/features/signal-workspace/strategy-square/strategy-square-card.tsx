...
export function RecommendedStrategySection({
  ...
  return (
    <section className={isDarkTheme ? "rounded-[28px] border border-white/[0.075] bg-white/[0.025] p-3 sm:p-4" : "rounded-[28px] border border-[#E8E8EC] bg-white/80 p-3 shadow-sm sm:p-4"}>
...
export function StrategyMarketplaceCard({
  ...
  const metricPanelClassName = isGridCard
    ? isDarkTheme
      ...
      : "mt-2 rounded-[14px] border border-[#E8E8EC] bg-gradient-to-b from-[#F8FCFF] to-white p-1.5 sm:rounded-[18px] sm:p-2 xl:mt-4 xl:rounded-[22px] xl:p-3"
    : isDarkTheme ? "mt-4 rounded-[22px] border border-white/[0.065] bg-[#101821] p-3" : "mt-4 rounded-[22px] border border-[#E8E8EC] bg-gradient-to-b from-[#F8FCFF] to-white p-3";
...
export function CardMetricRow({ isDarkTheme, label, value }: { isDarkTheme: boolean; label: string; value: string }) {
  return (
    <div className={isDarkTheme ? "min-w-0 rounded-2xl bg-white/[0.045] px-2.5 py-2" : "min-w-0 rounded-2xl bg-[#FAFAFA] px-2.5 py-2"}>
...
export function StrategyIcon({
  ...
  const iconClassName = variant === "grid"
    ? "relative grid h-7 w-7 shrink-0 place-items-center rounded-xl bg-[#6366F1] text-[10px] font-black text-white shadow-[0_8px_20px_rgba(99,102,241,0.24)] sm:h-9 sm:w-9 sm:rounded-2xl sm:text-xs xl:h-11 xl:w-11 xl:text-sm"
    : "relative grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[#6366F1] text-sm font-black text-white shadow-[0_8px_20px_rgba(99,102,241,0.24)]";
